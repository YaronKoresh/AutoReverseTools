...
set_target_properties(retdec::ctypes PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/retdec-ctypes.lib"
  )

list(APPEND _cmake_import_check_targets retdec::ctypes )
list(APPEND _cmake_import_check_files_for_retdec::ctypes "${_IMPORT_PREFIX}/lib/retdec-ctypes.lib" )
