...
set_target_properties(retdec::deps::authenticode PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/retdec-authenticode.lib"
  )

list(APPEND _cmake_import_check_targets retdec::deps::authenticode )
list(APPEND _cmake_import_check_files_for_retdec::deps::authenticode "${_IMPORT_PREFIX}/lib/retdec-authenticode.lib" )
